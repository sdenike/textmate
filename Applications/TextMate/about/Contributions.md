...
generate_credits(File.expand_path('~/Library/Caches/com.shelbydenike.TextMate/githubcredits'), warn) do |hash, author, subject, body, userpic, date, github_user|
...
%>
  <li class="commit commit-group-item">
    ...
    <p class="commit-title">
      <a href="https://github.com/textmatelives/textmate/commit/<%= hash %>" class="message"><%= subject %></a>
    ...
    <div class="commit-meta">
      <div class="commit-links">
        <a href="https://github.com/textmatelives/textmate/commit/<%= hash %>" class="gobutton">
          <span class="sha"><%= hash[0,10] %><span class="mini-icon mini-icon-arr-right-mini"></span></span>
        </a>
        <a href="https://github.com/textmatelives/textmate/tree/<%= hash %>" class="browse-button" title="Browse the code at this point in the history" rel="nofollow">Browse code <span class="mini-icon mini-icon-arr-right"></span></a>
      </div>
...
[1]: https://github.com/textmatelives/textmate/commits/main
